        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          >
            ...
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              HRITHIK <span className="gradient-text">A.R</span>
            </h1>
          </motion.div>
          ...
          >
            <span className="text-foreground font-semibold">Data Engineer</span>
          ...
          >
            ...
            <br /><br />
            <span className="text-foreground font-medium text-lg block mb-3">
              "Building scalable data systems and intelligent data-driven applications."
            </span>
            I specialize in developing high-performance data infrastructure across <strong>Python, SQL, PySpark, Apache Spark, Databricks, PostgreSQL, Azure, Data Modeling, ETL / Data Processing</strong>, and <strong>AI / LLM applications</strong>.
          </motion.p>
          ...
          >
            <a href="https://github.com/HR151103" target="_blank" rel="noopener noreferrer" className="social-icon">
              <Github size={20} />
            </a>
            <a href="https://linkedin.com/in/hrithik-a-ar-d47785247" target="_blank" rel="noopener noreferrer" className="social-icon">
              <Linkedin size={20} />
            </a>
            <a href="mailto:hrithik.a.r151103@gmail.com" className="social-icon">
              <Mail size={20} />
            </a>
          </motion.div>
          ...
          <div className="relative w-64 h-64 sm:w-80 sm:h-80">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-foreground">Data Engineer @ MethodHub</span>
              </div>
            </motion.div>
          </div>
        </motion.div>
