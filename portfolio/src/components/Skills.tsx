...
const skillCategories = [
    ...
    },
    {
        ...
        skills: ["Data Modeling", "Database Design", "ETL / ELT Pipelines", "Apache Spark", "Databricks", "Delta Lake", "PostgreSQL", "pgvector"],
    },
    {
        title: "AI & Cloud Tools",
        skills: ["Azure OpenAI", "RAG & LLMs", "Vector Search & Embeddings", "LangChain & ChromaDB", "Microsoft Azure", "Power BI", "Excel"],
    },
];
                            ...
                            >
                                ...
                                <ul className="space-y-2">
                                    {category.skills.map((skill, skillIndex) => (
                                        <li key={skillIndex} className="flex items-center text-gray-400 text-sm md:text-base">
