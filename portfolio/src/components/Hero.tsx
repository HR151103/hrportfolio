    ...
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 pt-20 pb-12 bg-gray-950 text-white selection:bg-teal-500 selection:text-white">
      ...
      >
        ...
        <motion.h2 
          ...
          className="text-3xl md:text-5xl text-teal-400 font-bold mb-4"
        >
          Data Engineer
        </motion.h2>
        ...
        >
          Data Engineering | Databricks | Apache Spark | Python | SQL | Data + AI
        </motion.p>
        ...
        <motion.p 
          ...
          className="max-w-2xl text-gray-400 mb-12 leading-relaxed text-base md:text-lg"
        >
          "Building scalable data systems and intelligent data-driven applications." I develop high-performance data infrastructure, processing pipelines, relational database schemas, and AI/LLM integrations using Python, SQL, PySpark, Databricks, PostgreSQL, Azure, and RAG.
        </motion.p>
        ...
        >
          <a href="https://github.com/HR151103" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-teal-400 hover:-translate-y-1 transition-all duration-300">
